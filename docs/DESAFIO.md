...
- **API en Go:** Recibirá la matriz original como entrada, realizará la rotación de la matriz o la factorización QR según la operación solicitada, y enviará los datos resultantes a la segunda API en Node.js.
...
- ✅ **Frontend:** Implementar un frontend que permita ejecutar ambas operaciones y muestre la factorización o rotación junto con las estadísticas de la segunda API.
